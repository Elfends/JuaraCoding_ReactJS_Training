          ...
          <Row>
            ...
            <Col>
              ...
              <Form.Group className="mb-3">
                ...
                <InputGroup className="mb-3">
                  <Form.Control placeholder="Name" type="text" name="name" value={deduction.name} onChange={(e) => handleAllowance(e)}/>
                  <Form.Control placeholder="Total" type="number" name="total" value={deduction.total || 0} onChange={(e) => handleAllowance(e)}/>
